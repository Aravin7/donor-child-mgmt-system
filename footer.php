  ...
  <footer class="sticky-footer bg-white">
    ...
    <!-- Page level plugins -->
    <script src="<?= SYSTEM_PATH ?>assets/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= SYSTEM_PATH ?>assets/js/demo/chart-area-demo.js"></script>
    <script src="<?= SYSTEM_PATH ?>assets/js/demo/chart-pie-demo.js"></script>
